...
class DDPG_agent():
    ...
    def __init__(self, task):
        ...
        self.noise_average = np.mean(self.noise.sample())
        ...
        # Global measurements of development
        self.score = -np.inf
    ...
    def step(self, action, reward, next_state, done):
        ...
        # Update score and number of steps
        self.total_reward += reward
        self.count += 1
        
        if done:
            # Update the best score
            self.score = self.total_reward #/ float(self.count + 1) if self.count else self.total_reward
